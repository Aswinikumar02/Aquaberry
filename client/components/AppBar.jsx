            ...
            <Grid.Column width={16}>
              ...
              >
                ...
                <Menu.Menu position="right">
                  <Link to="/wishList">
                    <Menu.Item style={{ marginTop: "15%",marginLeft:'8%' }}>
                      <Icon
                        name="empty heart"
                        size="large"
                      ...
                      <Label
                        color="red"
                        style={{ marginTop: "-23%", marginLeft: "29%" ,position:'absolute',zIndex:'100'}}
                        circular
                      >
                  ...
                  {/* <Link to='/cart'> */}
                      <Menu.Item style={{marginTop:'-2%'}}>
                        <Icon name='shopping cart' size='large' style={{color:'white',marginTop:'25%',marginLeft:'-28%'}}/>

                 <Label color='red' style={{marginTop:'-10%',marginLeft:'18%',position:'absolute',zIndex:'100'}} circular>{this.props.cartDetails.cartCount}</Label>
                      </Menu.Item>
                      </Menu.Menu>
                    </Menu>
                    </Grid.Column>
        ...
        >
          ...
          <Link to="/wishList">
            <MenuItem>
              <Header
                ...
                style={{ letterSpacing: "2px", textTransform: "capitalize" }}
              >
                <Icon size="small" name="heart" style={{ color: "#212121" }} />Saved
                Items
              </Header>
            </MenuItem>
          </Link>
          ...
          <Link to="/notification">
            <MenuItem>
              <h4
                ...
                style={{ letterSpacing: "2px", textTransform: "capitalize" }}
              >
                <Icon size="large" name="alarm" style={{ color: "#212121" }} />&nbsp;Notification&nbsp;<Label
                  circular
                  color="red"
                >
                  1
          ...
          <Link to="/promotions">
            <MenuItem>
              <Header
                ...
                style={{ letterSpacing: "2px", textTransform: "capitalize" }}
              >
                <Icon size="small" name="rocket" style={{ color: "#212121" }} />Promotions
                for you
              </Header>
            </MenuItem>
          </Link>
          ...
          <Link to="/feedback">
            <MenuItem>
              <Header
                ...
                style={{ letterSpacing: "2px", textTransform: "capitalize" }}
              >
                <Icon size="small" name="tasks" style={{ color: "#212121" }} />Feedback
              </Header>
            </MenuItem>
          </Link>
          <MenuItem>
          ...
          {/* <MenuItem>
            <Header
              ...
              style={{ letterSpacing: "2px", textTransform: "capitalize" }}
            >
              <Icon size="small" name="info" style={{ color: "#212121" }} />Help
              & FAQ's
            </Header>
          </MenuItem> */}
        </Drawer>

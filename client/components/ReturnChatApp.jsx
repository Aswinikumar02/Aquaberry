...
class ReturnChatApp extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      userInput: "",
          ...
          <Grid.Row>
            ...
            <Grid.Column width={14}>
              <Card style={{ width: "100%" }}>
                ...
                <Card.Content>{this.dataVAr()}</Card.Content>
                <Card.Content extra>
                  <Grid>
                    <Grid.Row>
                ...
                <Grid.Row>
                  ...
                  <Grid.Column width={14}>
                    <Header style={{ color: "white" }}>
                      <center>
                        Thanks Your Return Request has been updated
                        successfully!!!
                      </center>
                    </Header>
                  </Grid.Column>
